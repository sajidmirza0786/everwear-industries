    ...
    <div class="container">
        <div style="max-width: 680px; margin: 0 auto;">
            ...
            <div style="display:flex;align-items:center;gap:16px;padding:22px 24px;background:var(--surface);border:1px solid var(--line);margin-bottom:24px;">
                ...
                <div>
                    <div style="font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:var(--soft-2);margin-bottom:3px;">Order Confirmed</div>
                    ...
                    <div style="font-size:12px;color:var(--soft);margin-top:3px;">
                        Order <strong style="color:var(--ink);">#{{ $order->id }}</strong> placed · Confirmation sent to <strong style="color:var(--ink);">{{ $order->email }}</strong>
                    </div>
                </div>
            </div>
                        ...
                        <div class="oc-item-row {{ !$loop->last ? 'oc-item-border' : '' }}">
                            ...
                            <div style="flex:1;min-width:0;">
                                ...
                                <div style="display:flex;align-items:center;gap:8px;margin-top:4px;flex-wrap:wrap;">
                                    ...
                                    <span style="font-size:11px;color:var(--soft-2);">₹{{ number_format($item->price, 2) }}/unit</span>
                                </div>
                            </div>
